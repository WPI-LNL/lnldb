...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'CarouselImg.internal_name'
        db.add_column('pages_carouselimg', 'internal_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CarouselImg.internal_name'
        db.delete_column('pages_carouselimg', 'internal_name')
