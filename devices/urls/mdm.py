...
urlpatterns = [
    ...
    url(r'^app/(?P<pk>[0-9]+)/$', views.view_app, name="app-detail"),
    url(r'^app/(?P<pk>[0-9]+)/edit/$', views.update_app_info, name="edit-app"),
    url(r'^app/(?P<pk>[0-9]+)/refresh/$', views.reload_from_munki, name="app-refresh"),
    url(r'^app/(?P<pk>[0-9]+)/merge/$', views.merge_app, name="merge-app"),
