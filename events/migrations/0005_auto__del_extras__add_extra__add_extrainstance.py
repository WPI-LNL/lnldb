...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Extra'
        db.create_table('events_extra', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('cost', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
            ('desc', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('events', ['Extra'])

        # Adding model 'ExtraInstance'
        db.create_table('events_extrainstance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('extra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Extra'])),
            ('quant', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('events', ['ExtraInstance'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('events_extra')

        # Deleting model 'ExtraInstance'
        db.delete_table('events_extrainstance')
