...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.billed_by_semester'
        db.add_column(u'events_event', 'billed_by_semester',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.billed_by_semester'
        db.delete_column(u'events_event', 'billed_by_semester')
