...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('events_event', 'datetime_setup_start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 13, 0, 0)),
                      keep_default=False)

        # Adding field 'Event.datetime_setup_up'
        db.add_column('events_event', 'datetime_setup_up',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 13, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('events_event', 'time_setup_start',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 2, 13, 0, 0)),
                      keep_default=False)
        ...
        db.add_column('events_event', 'date_setup_start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 13, 0, 0)),
                      keep_default=False)

        # Deleting field 'Event.datetime_setup_start'
        db.delete_column('events_event', 'datetime_setup_start')

        # Deleting field 'Event.datetime_setup_up'
        db.delete_column('events_event', 'datetime_setup_up')
    ...
    models = {
        ...
        'events.event': {
            ...
            'datetime_setup_up': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        'events.service': {
            ...
            'extra': ('django.db.models.fields.related.ManyToManyField', [],
                      {'symmetrical': 'False', 'to': "orm['events.Extra']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
