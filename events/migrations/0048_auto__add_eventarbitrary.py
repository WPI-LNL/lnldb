...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'EventArbitrary'
        db.create_table(u'events_eventarbitrary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='arbitraryfees',
                                                                            to=orm['events.Event'])),
            ('key_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('key_value', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('key_quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'events', ['EventArbitrary'])

    def backwards(self, orm):
        # Deleting model 'EventArbitrary'
        db.delete_table(u'events_eventarbitrary')
    ...
    models = {
        ...
        u'events.ccreport': {
            ...
            'for_service_cat': ('django.db.models.fields.related.ManyToManyField', [],
                                {'to': u"orm['events.Category']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'events.eventarbitrary': {
            ...
            'key_quantity': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'key_value': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
