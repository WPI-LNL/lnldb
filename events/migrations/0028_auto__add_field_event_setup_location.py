...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'setup_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='setuplocation', null=True, to=orm['events.Location']),
                      keep_default=False)
    ...
    models = {
        ...
        u'events.event': {
            ...
            'otherservices': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['events.Service']", 'symmetrical': 'False'}),
