...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.setup_location'
        db.add_column(u'events_event', 'setup_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='setuplocation',
                                                                            null=True, to=orm['events.Location']),
                      keep_default=False)

        # Adding M2M table for field otherservices on 'Event'
        db.create_table(u'events_event_otherservices', (
        ...
        db.create_unique(u'events_event_otherservices', ['event_id', 'service_id'])

    def backwards(self, orm):
        # Deleting field 'Event.setup_location'
        db.delete_column(u'events_event', 'setup_location_id')

        # Removing M2M table for field otherservices on 'Event'
        db.delete_table('events_event_otherservices')
