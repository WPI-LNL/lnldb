...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'events_eventattachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['events.Event'])),
            ('for_service',
             self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='attachments', null=True,
                                                                   to=orm['events.Service'])),
            ('attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('note', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'events', ['EventAttachment'])

    def backwards(self, orm):
        # Deleting model 'EventAttachment'
        db.delete_table(u'events_eventattachment')
