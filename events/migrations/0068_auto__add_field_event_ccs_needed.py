...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.ccs_needed'
        db.add_column(u'events_event', 'ccs_needed',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.ccs_needed'
        db.delete_column(u'events_event', 'ccs_needed')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'ccs_needed': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
