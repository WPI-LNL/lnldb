...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'OrgBillingVerificationEvent'
        db.create_table(u'events_orgbillingverificationevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('org', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Organization'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('verified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='verification_events',
                                                                                  to=orm['auth.User'])),
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'events', ['OrgBillingVerificationEvent'])

    def backwards(self, orm):
        # Deleting model 'OrgBillingVerificationEvent'
        db.delete_table(u'events_orgbillingverificationevent')
    ...
    models = {
        ...
        u'events.eventattachment': {
            ...
            'for_service': ('django.db.models.fields.related.ForeignKey', [],
                            {'blank': 'True', 'related_name': "'attachments'", 'null': 'True',
        ...
        u'events.orgbillingverificationevent': {
            'Meta': {'object_name': 'OrgBillingVerificationEvent'},
