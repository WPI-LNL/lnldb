...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.otherservice_reqs'
        db.add_column(u'events_event', 'otherservice_reqs',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.show_in_wo_form'
        db.add_column(u'events_location', 'show_in_wo_form',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.otherservice_reqs'
        db.delete_column(u'events_event', 'otherservice_reqs')

        # Deleting field 'Location.show_in_wo_form'
        db.delete_column(u'events_location', 'show_in_wo_form')
