...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'events_billing', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_billed', self.gf('django.db.models.fields.DateField')()),
            ('date_paid', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('event',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='billings', to=orm['events.Event'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2)),
        ))
        db.send_create_signal(u'events', ['Billing'])

        # Adding field 'Event.approved_on'
        db.add_column(u'events_event', 'approved_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.closed_on'
        db.add_column(u'events_event', 'closed_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Event.cancelled_on'
        db.add_column(u'events_event', 'cancelled_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Billing'
        db.delete_table(u'events_billing')

        # Deleting field 'Event.approved_on'
        db.delete_column(u'events_event', 'approved_on')

        # Deleting field 'Event.closed_on'
        db.delete_column(u'events_event', 'closed_on')

        # Deleting field 'Event.cancelled'
        db.delete_column(u'events_event', 'cancelled')

        # Deleting field 'Event.cancelled_on'
        db.delete_column(u'events_event', 'cancelled_on')
