...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'OrganizationTransfer'
        db.create_table(u'events_organizationtransfer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('new_user_in_charge',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='xfer_new', to=orm['auth.User'])),
            ('old_user_in_charge',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='xfer_old', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'events', ['OrganizationTransfer'])

    def backwards(self, orm):
        # Deleting model 'OrganizationTransfer'
        db.delete_table(u'events_organizationtransfer')
