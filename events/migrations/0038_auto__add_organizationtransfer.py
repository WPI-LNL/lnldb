...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_organizationtransfer', (
            ...
            ('new_user_in_charge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='xfer_new', to=orm['auth.User'])),
            ('old_user_in_charge', self.gf('django.db.models.fields.related.ForeignKey')(related_name='xfer_old', to=orm['auth.User'])),
