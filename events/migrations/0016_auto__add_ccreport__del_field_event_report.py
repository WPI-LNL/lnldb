...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('events_ccreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('crew_chief', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('report', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('events', ['CCReport'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('events_ccreport')

        # Adding field 'Event.report'
        db.add_column('events_event', 'report',
