...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('events_organization', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Organization.email'
        db.alter_column('events_organization', 'email', self.gf('django.db.models.fields.EmailField')(default='gmp@glua.net', max_length=75))
