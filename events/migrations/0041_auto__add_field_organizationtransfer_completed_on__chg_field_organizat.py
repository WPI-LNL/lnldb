...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'OrganizationTransfer.completed_on'
        db.add_column(u'events_organizationtransfer', 'completed_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Changing field 'OrganizationTransfer.created'
        db.alter_column(u'events_organizationtransfer', 'created',
                        self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'OrganizationTransfer.completed_on'
        db.delete_column(u'events_organizationtransfer', 'completed_on')
