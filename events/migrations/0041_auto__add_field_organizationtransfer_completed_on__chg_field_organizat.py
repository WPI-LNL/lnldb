...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_organizationtransfer', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OrganizationTransfer.created'
        db.alter_column(u'events_organizationtransfer', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
