...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.datetime_setup_start'
        db.alter_column(u'events_event', 'datetime_setup_start', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.datetime_setup_start'
        db.alter_column(u'events_event', 'datetime_setup_start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 17, 0, 0)))
