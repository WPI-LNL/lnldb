...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.internal_notes'
        db.add_column(u'events_event', 'internal_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.internal_notes'
        db.delete_column(u'events_event', 'internal_notes')
