...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Location.setup_only'
        db.add_column(u'events_location', 'setup_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Location.setup_only'
        db.delete_column(u'events_location', 'setup_only')
