...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Adding field 'Extra.category'
        db.add_column('events_extra', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['events.Category']),
                      keep_default=False)

        # Adding field 'Service.category'
        db.add_column('events_service', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['events.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Extra.category'
        db.delete_column('events_extra', 'category_id')

        # Deleting field 'Service.category'
        db.delete_column('events_service', 'category_id')
