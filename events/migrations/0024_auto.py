...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field for_services on 'CCReport'
        db.delete_table('events_ccreport_for_services')

        # Adding M2M table for field for_service_cat on 'CCReport'
        db.create_table('events_ccreport_for_service_cat', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ccreport', models.ForeignKey(orm['events.ccreport'], null=False)),
            ('category', models.ForeignKey(orm['events.category'], null=False))
        ))
        db.create_unique('events_ccreport_for_service_cat', ['ccreport_id', 'category_id'])


    def backwards(self, orm):
        # Adding M2M table for field for_services on 'CCReport'
        db.create_table('events_ccreport_for_services', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ccreport', models.ForeignKey(orm['events.ccreport'], null=False)),
            ('service', models.ForeignKey(orm['events.service'], null=False))
        ))
        db.create_unique('events_ccreport_for_services', ['ccreport_id', 'service_id'])

        # Removing M2M table for field for_service_cat on 'CCReport'
        db.delete_table('events_ccreport_for_service_cat')
    ...
    models = {
        ...
        'events.ccreport': {
            ...
            'crew_chief': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['events.Event']"}),
            'for_service_cat': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.Category']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'events.event': {
            ...
            'crew': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'crewx'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'crew_chief': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'crewchiefx'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
