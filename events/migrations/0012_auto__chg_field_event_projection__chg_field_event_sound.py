...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Event.projection' to match new field type.
        db.rename_column('events_event', 'projection', 'projection_id')
        # Changing field 'Event.projection'
        db.alter_column('events_event', 'projection_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Projection']))
        # Adding index on 'Event', fields ['projection']
        db.create_index('events_event', ['projection_id'])


        # Changing field 'Event.sound'
        db.alter_column('events_event', 'sound_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Sound']))

    def backwards(self, orm):
        # Removing index on 'Event', fields ['projection']
        db.delete_index('events_event', ['projection_id'])


        # Renaming column for 'Event.projection' to match new field type.
        db.rename_column('events_event', 'projection_id', 'projection')
        # Changing field 'Event.projection'
        db.alter_column('events_event', 'projection', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Event.sound'
        db.alter_column('events_event', 'sound_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Projection']))
