...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column('events_event', 'projection_id',
        ...
        db.alter_column('events_event', 'sound_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Sound']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.projection'
        db.alter_column('events_event', 'projection',
