...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'billing_fund_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['events.Fund']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.billing_fund'
        db.alter_column(u'events_event', 'billing_fund_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Fund']))
        ...
        raise RuntimeError("Cannot reverse this migration. 'Organization.organization' and its values cannot be restored.")
    ...
    models = {
        ...
        u'events.event': {
            ...
            'billing_fund': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_accounts'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['events.Fund']"}),
        ...
        u'events.organization': {
            ...
            'accounts': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'orgfunds'", 'null': 'True', 'to': u"orm['events.Fund']"}),
