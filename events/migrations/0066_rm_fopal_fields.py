...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Event.billing_fund'
        db.alter_column(u'events_event', 'billing_fund_id',
        ...
        db.delete_column(u'events_organization', 'account')

        # Deleting field 'Organization.fund'
        db.delete_column(u'events_organization', 'fund')

        # Deleting field 'Organization.organization'
        db.delete_column(u'events_organization', 'organization')

    def backwards(self, orm):
        # Changing field 'Event.billing_fund'
        db.alter_column(u'events_event', 'billing_fund_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Fund']))
        # Adding field 'Organization.account'
        db.add_column(u'events_organization', 'account',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Organization.fund'
        raise RuntimeError("Cannot reverse this migration. 'Organization.fund' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'Organization.fund'
        db.add_column(u'events_organization', 'fund',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Organization.organization'
        raise RuntimeError(
            "Cannot reverse this migration. 'Organization.organization' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'Organization.organization'
        db.add_column(u'events_organization', 'organization',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)
    ...
    models = {
        ...
        u'events.billing': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'billings'", 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'events.ccreport': {
            ...
            'for_service_cat': ('django.db.models.fields.related.ManyToManyField', [],
                                {'symmetrical': 'False', 'to': u"orm['events.Category']", 'null': 'True',
                                 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'events.event': {
            ...
            'billed_by_semester': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'billing_fund': ('django.db.models.fields.related.ForeignKey', [],
                             {'related_name': "'event_accounts'", 'null': 'True', 'on_delete': 'models.SET_NULL',
                              'to': u"orm['events.Fund']"}),
        ...
        u'events.eventarbitrary': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'arbitraryfees'", 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'events.eventattachment': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'attachments'", 'to': u"orm['events.Event']"}),
            'externally_uploaded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'for_service': ('django.db.models.fields.related.ManyToManyField', [],
                            {'blank': 'True', 'related_name': "'attachments'", 'null': 'True', 'symmetrical': 'False',
                             'to': u"orm['events.Service']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'events.eventccinstance': {
            ...
            'crew_chief': ('django.db.models.fields.related.ForeignKey', [],
                           {'related_name': "'ccinstances'", 'to': u"orm['auth.User']"}),
            'event': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'ccinstances'", 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service': ('django.db.models.fields.related.ForeignKey', [],
                        {'related_name': "'ccinstances'", 'to': u"orm['events.Service']"}),
            'setup_location': ('django.db.models.fields.related.ForeignKey', [],
                               {'related_name': "'ccinstances'", 'to': u"orm['events.Location']"}),
        ...
        u'events.extra': {
            ...
            'services': ('django.db.models.fields.related.ManyToManyField', [],
                         {'to': u"orm['events.Service']", 'symmetrical': 'False'})
        },
        ...
        u'events.fund': {
            ...
            'last_used': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        u'events.hours': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'hours'", 'to': u"orm['events.Event']"}),
            'hours': ('django.db.models.fields.DecimalField', [],
                      {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service': ('django.db.models.fields.related.ForeignKey', [],
                        {'blank': 'True', 'related_name': "'hours'", 'null': 'True', 'to': u"orm['events.Service']"}),
            'user': (
                'django.db.models.fields.related.ForeignKey', [],
                {'related_name': "'hours'", 'to': u"orm['auth.User']"})
        },
        u'events.lighting': {
        ...
        u'events.organization': {
            ...
            'accounts': ('django.db.models.fields.related.ManyToManyField', [],
                         {'symmetrical': 'False', 'related_name': "'orgfunds'", 'null': 'True',
                          'to': u"orm['events.Fund']"}),
        ...
        u'events.organizationtransfer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_user_in_charge': ('django.db.models.fields.related.ForeignKey', [],
                                   {'related_name': "'xfer_new'", 'to': u"orm['auth.User']"}),
            'old_user_in_charge': ('django.db.models.fields.related.ForeignKey', [],
                                   {'related_name': "'xfer_old'", 'to': u"orm['auth.User']"}),
        ...
        u'events.orgbillingverificationevent': {
            ...
            'org': ('django.db.models.fields.related.ForeignKey', [],
                    {'related_name': "'verifications'", 'to': u"orm['events.Organization']"}),
            'verified_by': ('django.db.models.fields.related.ForeignKey', [],
                            {'related_name': "'verification_events'", 'to': u"orm['auth.User']"})
        },
        u'events.projection': {
        ...
        u'events.reportreminder': {
            ...
            'crew_chief': ('django.db.models.fields.related.ForeignKey', [],
                           {'related_name': "'ccreportreminders'", 'to': u"orm['auth.User']"}),
            'event': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'ccreportreminders'", 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
