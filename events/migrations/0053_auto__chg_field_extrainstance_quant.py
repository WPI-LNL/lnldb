...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'ExtraInstance.quant'
        db.alter_column(u'events_extrainstance', 'quant', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Changing field 'ExtraInstance.quant'
        db.alter_column(u'events_extrainstance', 'quant', self.gf('django.db.models.fields.IntegerField')())
