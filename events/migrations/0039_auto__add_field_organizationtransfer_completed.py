...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'OrganizationTransfer.completed'
        db.add_column(u'events_organizationtransfer', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'OrganizationTransfer.completed'
        db.delete_column(u'events_organizationtransfer', 'completed')
