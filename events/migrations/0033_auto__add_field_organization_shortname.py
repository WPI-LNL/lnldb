...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Organization.shortname'
        db.add_column(u'events_organization', 'shortname',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Organization.shortname'
        db.delete_column(u'events_organization', 'shortname')
