...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.submitted_on'
        db.add_column('events_event', 'submitted_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True,
                                                                       default=datetime.datetime(2013, 3, 25, 0, 0),
                                                                       blank=True),
                      keep_default=False)

        # Adding field 'Event.lighting_reqs'
        db.add_column('events_event', 'lighting_reqs',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.sound_reqs'
        db.add_column('events_event', 'sound_reqs',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.proj_reqs'
        db.add_column('events_event', 'proj_reqs',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.submitted_on'
        db.delete_column('events_event', 'submitted_on')

        # Deleting field 'Event.lighting_reqs'
        db.delete_column('events_event', 'lighting_reqs')

        # Deleting field 'Event.sound_reqs'
        db.delete_column('events_event', 'sound_reqs')

        # Deleting field 'Event.proj_reqs'
        db.delete_column('events_event', 'proj_reqs')
