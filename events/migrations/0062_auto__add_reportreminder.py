...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_reportreminder', (
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccreportreminders', to=orm['events.Event'])),
            ('crew_chief', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccreportreminders', to=orm['auth.User'])),
