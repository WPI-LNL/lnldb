...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'ReportReminder'
        db.create_table(u'events_reportreminder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccreportreminders',
                                                                            to=orm['events.Event'])),
            ('crew_chief', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccreportreminders',
                                                                                 to=orm['auth.User'])),
            ('sent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'events', ['ReportReminder'])

    def backwards(self, orm):
        # Deleting model 'ReportReminder'
        db.delete_table(u'events_reportreminder')
