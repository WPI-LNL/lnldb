...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.cancelled_reason'
        db.add_column(u'events_event', 'cancelled_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.cancelled_reason'
        db.delete_column(u'events_event', 'cancelled_reason')
