...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.billing_org'
        db.add_column(u'events_event', 'billing_org',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='billedevents',
                                                                            null=True, to=orm['events.Organization']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Event.billing_org'
        db.delete_column(u'events_event', 'billing_org_id')
