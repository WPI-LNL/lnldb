...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.delete_column('events_service', 'cost')

        # Adding field 'Service.base_cost'
        db.add_column('events_service', 'base_cost',
                      self.gf('django.db.models.fields.DecimalField')(default="0.0", max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Service.addtl_cost'
        db.add_column('events_service', 'addtl_cost',
                      self.gf('django.db.models.fields.DecimalField')(default="0.0", max_digits=8, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Service.cost'
        db.add_column('events_service', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default="0.0", max_digits=8, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Service.base_cost'
        db.delete_column('events_service', 'base_cost')

        # Deleting field 'Service.addtl_cost'
        db.delete_column('events_service', 'addtl_cost')
