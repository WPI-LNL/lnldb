...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='eventapprovals', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.closed_by'
        db.add_column(u'events_event', 'closed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='eventclosings', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.cancelled_by'
        db.add_column(u'events_event', 'cancelled_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='eventcancellations', null=True, to=orm['auth.User']),
                      keep_default=False)
