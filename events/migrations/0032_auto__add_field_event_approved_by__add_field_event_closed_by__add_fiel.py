...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.approved_by'
        db.add_column(u'events_event', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='eventapprovals',
                                                                            null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.closed_by'
        db.add_column(u'events_event', 'closed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='eventclosings',
                                                                            null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.cancelled_by'
        db.add_column(u'events_event', 'cancelled_by',
    ...
    def backwards(self, orm):
        # Deleting field 'Event.approved_by'
        db.delete_column(u'events_event', 'approved_by_id')

        # Deleting field 'Event.closed_by'
        db.delete_column(u'events_event', 'closed_by_id')

        # Deleting field 'Event.cancelled_by'
        db.delete_column(u'events_event', 'cancelled_by_id')
