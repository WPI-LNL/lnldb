...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_lighting', (
            ('service_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['events.Service'], unique=True, primary_key=True)),
        ))
        ...
        db.alter_column('events_event', 'lighting_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Lighting']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.lighting'
        db.alter_column('events_event', 'lighting_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['events.Services']))
    ...
    models = {
        ...
        'events.service': {
            ...
            'cost': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'extra': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.Extra']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
