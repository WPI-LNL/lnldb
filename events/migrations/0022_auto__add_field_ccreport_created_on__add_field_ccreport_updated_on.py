...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CCReport.created_on'
        db.add_column('events_ccreport', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CCReport.updated_on'
        db.add_column('events_ccreport', 'updated_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 4, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CCReport.created_on'
        db.delete_column('events_ccreport', 'created_on')

        # Deleting field 'CCReport.updated_on'
        db.delete_column('events_ccreport', 'updated_on')
