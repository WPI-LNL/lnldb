...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'events_building', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('shortname', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal(u'events', ['Building'])

        # Adding field 'Location.building'
        db.add_column(u'events_location', 'building',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['events.Building']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'events_building')

        # Deleting field 'Location.building'
        db.delete_column(u'events_location', 'building_id')
