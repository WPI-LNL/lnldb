...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field ccrew_chief on 'Event'
        db.create_table('events_event_ccrew_chief', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('events_event_ccrew_chief', ['event_id', 'user_id'])

        # Adding M2M table for field ccrew on 'Event'
        db.create_table('events_event_ccrew', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('events_event_ccrew', ['event_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field ccrew_chief on 'Event'
        db.delete_table('events_event_ccrew_chief')

        # Removing M2M table for field ccrew on 'Event'
        db.delete_table('events_event_ccrew')
    ...
    models = {
        ...
        'events.event': {
            ...
            'ccrew': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'crew'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'ccrew_chief': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'crewchief'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
