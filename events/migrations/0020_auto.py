...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field ecrew_chief on 'Event'
        db.create_table('events_event_ecrew_chief', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('events_event_ecrew_chief', ['event_id', 'user_id'])

        # Adding M2M table for field ecrew on 'Event'
        db.create_table('events_event_ecrew', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('events_event_ecrew', ['event_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field ecrew_chief on 'Event'
        db.delete_table('events_event_ecrew_chief')

        # Removing M2M table for field ecrew on 'Event'
        db.delete_table('events_event_ecrew')
    ...
    models = {
        ...
        'events.event': {
            ...
            'ecrew': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'crewx'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'ecrew_chief': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'crewchiefx'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
