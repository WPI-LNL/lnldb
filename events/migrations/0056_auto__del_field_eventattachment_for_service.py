...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'EventAttachment.for_service'
        db.delete_column(u'events_eventattachment', 'for_service_id')

        # Adding M2M table for field for_service on 'EventAttachment'
        db.create_table(u'events_eventattachment_for_service', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventattachment', models.ForeignKey(orm[u'events.eventattachment'], null=False)),
            ('service', models.ForeignKey(orm[u'events.service'], null=False))
        ))
        db.create_unique(u'events_eventattachment_for_service', ['eventattachment_id', 'service_id'])

    def backwards(self, orm):
        # Adding field 'EventAttachment.for_service'
        db.add_column(u'events_eventattachment', 'for_service',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', null=True,
                                                                            to=orm['events.Service'], blank=True),
                      keep_default=False)

        # Removing M2M table for field for_service on 'EventAttachment'
        db.delete_table('events_eventattachment_for_service')
