...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Organization.archived'
        db.add_column(u'events_organization', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Organization.archived'
        db.delete_column(u'events_organization', 'archived')
