...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.sensitive'
        db.add_column(u'events_event', 'sensitive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.test_event'
        db.add_column(u'events_event', 'test_event',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.sensitive'
        db.delete_column(u'events_event', 'sensitive')

        # Deleting field 'Event.test_event'
        db.delete_column(u'events_event', 'test_event')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'sensitive': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'test_event': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        u'events.hours': {
            ...
            'user': (
            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'hours'", 'to': u"orm['auth.User']"})
        },
        u'events.lighting': {
        ...
        u'events.organization': {
            ...
            'user_in_charge': (
            'django.db.models.fields.related.ForeignKey', [], {'related_name': "'orgowner'", 'to': u"orm['auth.User']"})
        },
