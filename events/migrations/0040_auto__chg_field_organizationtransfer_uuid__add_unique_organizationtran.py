...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_organizationtransfer', 'uuid', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OrganizationTransfer.uuid'
        db.alter_column(u'events_organizationtransfer', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=32))
