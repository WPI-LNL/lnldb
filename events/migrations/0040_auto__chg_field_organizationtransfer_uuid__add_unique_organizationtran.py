...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'OrganizationTransfer.uuid'
        db.alter_column(u'events_organizationtransfer', 'uuid',
                        self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32))
        # Adding unique constraint on 'OrganizationTransfer', fields ['uuid']
        db.create_unique(u'events_organizationtransfer', ['uuid'])

    def backwards(self, orm):
        # Removing unique constraint on 'OrganizationTransfer', fields ['uuid']
        db.delete_unique(u'events_organizationtransfer', ['uuid'])
