...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'EventArbitrary.key_quantity'
        db.alter_column(u'events_eventarbitrary', 'key_quantity',
                        self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):
        # Changing field 'EventArbitrary.key_quantity'
        db.alter_column(u'events_eventarbitrary', 'key_quantity', self.gf('django.db.models.fields.IntegerField')())
