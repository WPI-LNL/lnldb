...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Changing field 'Organization.address'
        db.alter_column('events_organization', 'address', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Organization.address'
        db.alter_column('events_organization', 'address', self.gf('django.db.models.fields.TextField')(default=''))
