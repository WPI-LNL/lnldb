...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Location.available_for_meetings'
        db.add_column(u'events_location', 'available_for_meetings',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Location.available_for_meetings'
        db.delete_column(u'events_location', 'available_for_meetings')
