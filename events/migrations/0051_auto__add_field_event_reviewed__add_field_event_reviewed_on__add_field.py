...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.reviewed'
        db.add_column(u'events_event', 'reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.reviewed_on'
        db.add_column(u'events_event', 'reviewed_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.reviewed_by'
        db.add_column(u'events_event', 'reviewed_by',
    ...
    def backwards(self, orm):
        # Deleting field 'Event.reviewed'
        db.delete_column(u'events_event', 'reviewed')

        # Deleting field 'Event.reviewed_on'
        db.delete_column(u'events_event', 'reviewed_on')

        # Deleting field 'Event.reviewed_by'
        db.delete_column(u'events_event', 'reviewed_by_id')
