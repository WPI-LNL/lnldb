...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'EventArbitrary.key_value'
        db.alter_column(u'events_eventarbitrary', 'key_value',
                        self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):
        # Changing field 'EventArbitrary.key_value'
        db.alter_column(u'events_eventarbitrary', 'key_value', self.gf('django.db.models.fields.IntegerField')())
