...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Organization.last_updated'
        db.add_column(u'events_organization', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True,
                                                                       default=datetime.datetime(2013, 9, 20, 0, 0),
                                                                       blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Organization.last_updated'
        db.delete_column(u'events_organization', 'last_updated')
