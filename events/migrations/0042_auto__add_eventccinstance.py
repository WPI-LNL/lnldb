...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'EventCCInstance'
        db.create_table(u'events_eventccinstance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccinstances', to=orm['events.Event'])),
            ('crew_chief',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccinstances', to=orm['auth.User'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccinstances',
                                                                              to=orm['events.Service'])),
            ('setup_location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccinstances',
                                                                                     to=orm['events.Location'])),
            ('setup_start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'events', ['EventCCInstance'])

    def backwards(self, orm):
        # Deleting model 'EventCCInstance'
        db.delete_table(u'events_eventccinstance')
