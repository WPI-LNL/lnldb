...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_eventccinstance', (
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccinstances', to=orm['events.Event'])),
            ('crew_chief', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccinstances', to=orm['auth.User'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccinstances', to=orm['events.Service'])),
            ('setup_location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ccinstances', to=orm['events.Location'])),
