...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Event.contact'
        db.add_column(u'events_event', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Changing field 'EventAttachment.note'
        db.alter_column(u'events_eventattachment', 'note', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Event.contact'
        db.delete_column(u'events_event', 'contact_id')


        # User chose to not deal with backwards NULL issues for 'EventAttachment.note'
        raise RuntimeError("Cannot reverse this migration. 'EventAttachment.note' and its values cannot be restored.")
