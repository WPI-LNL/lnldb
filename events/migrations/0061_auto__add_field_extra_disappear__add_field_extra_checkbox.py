...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Extra.disappear'
        db.add_column(u'events_extra', 'disappear',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Extra.checkbox'
        db.add_column(u'events_extra', 'checkbox',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Extra.disappear'
        db.delete_column(u'events_extra', 'disappear')

        # Deleting field 'Extra.checkbox'
        db.delete_column(u'events_extra', 'checkbox')
