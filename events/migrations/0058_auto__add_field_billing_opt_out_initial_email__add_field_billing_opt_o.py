...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Billing.opt_out_initial_email'
        db.add_column(u'events_billing', 'opt_out_initial_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Billing.opt_out_update_email'
        db.add_column(u'events_billing', 'opt_out_update_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Billing.opt_out_initial_email'
        db.delete_column(u'events_billing', 'opt_out_initial_email')

        # Deleting field 'Billing.opt_out_update_email'
        db.delete_column(u'events_billing', 'opt_out_update_email')
