...
urlpatterns = [
    ...
    url(r'^unreviewedsemester/', generate_date_patterns(list_views.unreviewed_semester, name="unreviewed-semester")),
    ...
    url(r'^unpaidsemester/', generate_date_patterns(list_views.unpaid_semester, name="unpaid-semester")),
