...
class Event(models.Model):
    ...
    class Meta:
        permissions = (
            ...
            ("add_ccreport", "Add crew chief reports about the event"),
            ("change_ccreport", "Change crew chief reports about the event"),
            ("delete_ccreport", "Delete crew chief reports about the event"),
