...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'EquipmentMaintEntry.desc'
        db.add_column('inventory_equipmentmaintentry', 'desc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EquipmentMaintEntry.desc'
        db.delete_column('inventory_equipmentmaintentry', 'desc')
