...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Equipment.purchase_cost'
        db.add_column('inventory_equipment', 'purchase_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equipment.purchase_cost'
        db.delete_column('inventory_equipment', 'purchase_cost')
    ...
    models = {
        ...
        'inventory.equipment': {
            ...
            'purchase_cost': ('django.db.models.fields.DecimalField', [], {'max_digits': '9', 'decimal_places': '2'}),
