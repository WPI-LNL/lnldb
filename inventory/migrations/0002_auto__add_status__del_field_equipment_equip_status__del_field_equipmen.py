...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'Status'
        db.create_table('inventory_status', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('iconclass', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('inventory', ['Status'])

        # Deleting field 'Equipment.equip_status'
        db.delete_column('inventory_equipment', 'equip_status')

        # Deleting field 'Equipment.purchase_price'
        db.delete_column('inventory_equipment', 'purchase_price')

        # Adding field 'EquipmentMaintEntry.status'
        db.add_column('inventory_equipmentmaintentry', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, null=True,
                                                                            to=orm['inventory.Status']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Status'
        db.delete_table('inventory_status')

        # Adding field 'Equipment.equip_status'
        db.add_column('inventory_equipment', 'equip_status',
                      self.gf('django.db.models.fields.CharField')(default='AV', max_length=2),
                      keep_default=False)

        # Adding field 'Equipment.purchase_price'
        db.add_column('inventory_equipment', 'purchase_price',
                      self.gf('django.db.models.fields.IntegerField')(default=0.0),
                      keep_default=False)

        # Deleting field 'EquipmentMaintEntry.status'
        db.delete_column('inventory_equipmentmaintentry', 'status_id')
    ...
    models = {
        ...
        'inventory.equipmentmaintentry': {
            'Meta': {'ordering': "['-ts']", 'object_name': 'EquipmentMaintEntry'},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['inventory.Status']"}),
            'ts': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'inventory.status': {
            'Meta': {'object_name': 'Status'},
            'iconclass': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
