    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usual_place', models.ForeignKey(blank=True, to='events.Location',
                                                  help_text=b'Default place for items of this category. Inherits from parent categories.',
                                                  null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description',
                 models.TextField(help_text=b'Function, appearance, and included acessories', null=True, blank=True)),
                ('value', models.DecimalField(help_text=b'Estimated purchase value', max_digits=9, decimal_places=2)),
                ('model_number', models.CharField(max_length=256)),
                ('manufacturer', models.CharField(max_length=128)),
                ('length', models.DecimalField(help_text=b'Length in inches', max_digits=6, decimal_places=2)),
                ('width', models.DecimalField(help_text=b'Width in inches', max_digits=6, decimal_places=2)),
                ('height', models.DecimalField(help_text=b'Height in inches', max_digits=6, decimal_places=2)),
                ('weight', models.DecimalField(help_text=b'Weight in lbs.', max_digits=6, decimal_places=2)),
                ('wiki_text', models.TextField(help_text=b'How to use this item')),
