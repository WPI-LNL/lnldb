...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetingAnnounce.added'
        db.add_column(u'meetings_meetingannounce', 'added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeetingAnnounce.added'
        db.delete_column(u'meetings_meetingannounce', 'added')
