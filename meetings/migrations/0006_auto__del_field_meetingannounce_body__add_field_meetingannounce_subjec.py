...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'MeetingAnnounce.body'
        db.delete_column(u'meetings_meetingannounce', 'body')

        # Adding field 'MeetingAnnounce.subject'
        db.add_column(u'meetings_meetingannounce', 'subject',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=128),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'MeetingAnnounce.body'
        db.add_column(u'meetings_meetingannounce', 'body',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=128),
                      keep_default=False)

        # Deleting field 'MeetingAnnounce.subject'
        db.delete_column(u'meetings_meetingannounce', 'subject')
