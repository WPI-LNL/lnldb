...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'MeetingAnnounce.uuid'
        db.add_column(u'meetings_meetingannounce', 'uuid',
                      self.gf('uuidfield.fields.UUIDField')(max_length=32, unique=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MeetingAnnounce.uuid'
        db.delete_column(u'meetings_meetingannounce', 'uuid')
