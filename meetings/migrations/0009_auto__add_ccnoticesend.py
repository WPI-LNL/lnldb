...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CCNoticeSend'
        db.create_table(u'meetings_ccnoticesend', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meeting', self.gf('django.db.models.fields.related.ForeignKey')(related_name='meetingccnotices', to=orm['meetings.Meeting'])),
        ...
        db.send_create_signal(u'meetings', ['CCNoticeSend'])

        # Adding M2M table for field events on 'CCNoticeSend'
        db.create_table(u'meetings_ccnoticesend_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ccnoticesend', models.ForeignKey(orm[u'meetings.ccnoticesend'], null=False)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False))
        ))
        db.create_unique(u'meetings_ccnoticesend_events', ['ccnoticesend_id', 'event_id'])


    def backwards(self, orm):
        # Deleting model 'CCNoticeSend'
        db.delete_table(u'meetings_ccnoticesend')

        # Removing M2M table for field events on 'CCNoticeSend'
        db.delete_table('meetings_ccnoticesend_events')
