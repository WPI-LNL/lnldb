...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'meetings_meeting', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Location'], null=True,
                                                                            blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Meeting.location'
        db.delete_column(u'meetings_meeting', 'location_id')
