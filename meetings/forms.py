...
class MeetingAdditionForm(FieldAccessForm):
    ...
    attachments_private = MultiFileField(max_file_size=1024 * 1024 * 20,  # 20 MB
                                         ...
                                         required=False)
    minutes = forms.CharField(widget=EasyMDEEditor(),
                              required=False)
    agenda = forms.CharField(widget=EasyMDEEditor(),
                             required=False)
    minutes_private = forms.CharField(widget=EasyMDEEditor(), label="Closed Minutes", required=False)
