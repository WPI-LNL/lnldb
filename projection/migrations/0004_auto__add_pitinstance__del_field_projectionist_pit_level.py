...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'projection_pitinstance', (
            ...
            ('projectionist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pitinstances', to=orm[
                'projection.Projectionist'])),
            ('pit_level', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pitinstances',
                                                                                to=orm['projection.PITLevel'])),
