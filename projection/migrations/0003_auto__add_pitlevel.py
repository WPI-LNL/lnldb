...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PitLevel'
        db.create_table(u'projection_pitlevel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name_short', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('name_long', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ))
        db.send_create_signal(u'projection', ['PitLevel'])


    def backwards(self, orm):
        # Deleting model 'PitLevel'
        db.delete_table(u'projection_pitlevel')
