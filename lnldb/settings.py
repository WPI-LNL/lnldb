...
GRAPH_API_AUTHORITY = env.str("GRAPH-API_AUTHORITY", "")
GRAPH_API_CLIENT_ID = env.str("GRAPH-API_CLIENT_ID", "")
GRAPH_API_SCOPE = env.str("GRAPH-API_SCOPE", "")
GRAPH_API_SECRET = env.str("GRAPH-API_SECRET", "")
GRAPH_API_ENDPOINT = env.str("GRAPH-API_ENDPOINT", "")
