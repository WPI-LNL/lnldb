...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Orgsync_Org.president_email'
        db.add_column(u'acct_orgsync_org', 'president_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Orgsync_Org.president_email'
        db.delete_column(u'acct_orgsync_org', 'president_email')
