...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.locked'
        db.add_column(u'acct_profile', 'locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.locked'
        db.delete_column(u'acct_profile', 'locked')
    ...
    models = {
        u'acct.orgsync_org': {
            ...
            'org_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
        ...
        u'acct.profile': {
            ...
            'mdc': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
