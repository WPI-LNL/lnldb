...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Orgsync_Org.keywords'
        db.add_column(u'acct_orgsync_org', 'keywords',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Orgsync_Org.keywords'
        db.delete_column(u'acct_orgsync_org', 'keywords')
