...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'Orgsync_OrgCat'
        db.create_table(u'acct_orgsync_orgcat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('orgsync_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'acct', ['Orgsync_OrgCat'])

        # Adding field 'Orgsync_Org.category'
        db.add_column(u'acct_orgsync_org', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acct.Orgsync_OrgCat'], null=True,
                                                                            blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Orgsync_OrgCat'
        db.delete_table(u'acct_orgsync_orgcat')

        # Deleting field 'Orgsync_Org.category'
        db.delete_column(u'acct_orgsync_org', 'category_id')

    models = {
        u'acct.orgsync_org': {
            'Meta': {'object_name': 'Orgsync_Org'},
            'category': ('django.db.models.fields.related.ForeignKey', [],
                         {'to': u"orm['acct.Orgsync_OrgCat']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'orgsync_id': ('django.db.models.fields.IntegerField', [], {})
        },
        u'acct.orgsync_orgcat': {
            'Meta': {'object_name': 'Orgsync_OrgCat'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'acct.orgsync_user': {
            ...
            'memberships': ('django.db.models.fields.related.ManyToManyField', [],
                            {'symmetrical': 'False', 'to': u"orm['acct.Orgsync_Org']", 'null': 'True',
                             'blank': 'True'}),
            'orgsync_id': ('django.db.models.fields.IntegerField', [], {}),
            'portfolio': (
