...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'acct_orgsync_org', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acct.Orgsync_OrgCat'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        u'acct.orgsync_org': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['acct.Orgsync_OrgCat']", 'null': 'True', 'blank': 'True'}),
